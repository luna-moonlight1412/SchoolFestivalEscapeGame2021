...
CODE=[[pygame.image.load("image/3/1.png"),
       pygame.image.load("image/3/2.png"),
       pygame.image.load("image/3/3.png"),
       pygame.image.load("image/3/4.png"),
       pygame.image.load("image/3/5.png"),
       pygame.image.load("image/3/6.png")]]
...
def main():
    ...
    while True:
        ...
        if index==2:
            index=0
            ch=1
            with open('../../progress/flg/stage3_3.binary','wb') as web:
                pickle.dump(ch,web)
            ch=3
