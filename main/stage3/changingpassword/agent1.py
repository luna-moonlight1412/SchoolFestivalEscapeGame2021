...
CODE=[[pygame.image.load("image/1/1.png"),
       pygame.image.load("image/1/2.png"),
       pygame.image.load("image/1/3.png"),
       pygame.image.load("image/1/4.png"),
       pygame.image.load("image/1/5.png"),
       pygame.image.load("image/1/6.png")]]
...
PASS=[[[4, 0], [1, 5], [3, 4], [2, 1], [1, 3], [1, 4], [3, 2], [0, 3], [4, 3], [3, 0], [3, 5], [5, 1], [0, 4], [1, 0], [3, 1], [4, 1], [2, 3], [4, 5], [5, 2], [5, 4], [0, 5], [2, 5], [2, 4], [0, 1], [4, 2], [5, 0], [2, 0], [5, 3], [0, 2], [1, 2]],]
...
def main():
    ...
    while True:
        ...
        if index==2:
            index=0
            ch=1
            with open('../../progress/flg/stage3_1.binary','wb') as web:
                pickle.dump(ch,web)
